...
//                   !!! filetypes you may modify !!!  be careful to keep them between the () and seperated with |
//                                         \      /
//                                          \    /
//                                           \  /
//                                            \/
Function findAllFiles($dir=".", $match='/(.zip|.wav|.wma|.flac|.txt|.odt|.html|.jpg|.png)$/i')  { //note I ignore .htm files as those not to share, while including .html files; this purposely seperates thier funcions on the server.
